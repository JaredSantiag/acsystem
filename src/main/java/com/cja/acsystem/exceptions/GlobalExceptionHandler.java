...
import com.cja.acsystem.dto.ErrorDetalles;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler(AcsystemAppException.class)
	public ResponseEntity<ErrorDetalles> manejarSialAppException(AcsystemAppException exception, WebRequest webRequest){
		ErrorDetalles errorDetalles = new ErrorDetalles(new Date(), exception.getMessage(), webRequest.getDescription(false));
